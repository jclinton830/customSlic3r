...
LayerRegion::make_fill()
{
    ...
    const double fill_spacing          = this->region()->config.fill_spacing;
    ...
    for (Surfaces::const_iterator surface_it = surfaces.surfaces.begin();
        ...
        if (!surface.is_solid() && !is_bridge) {
            ...
            if(fill_pattern == ipBioRectilinear ){
              f->min_spacing = fill_spacing;
              f->fill_spacing = fill_spacing;
