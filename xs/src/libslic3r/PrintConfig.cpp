...
PrintConfigDef::PrintConfigDef()
{
    ...
    external_fill_pattern.enum_values.push_back("biorectilinear");
    ...
    external_fill_pattern.enum_labels.push_back("Bio Rectilnear");
    ...
    def = this->add("fill_spacing", coFloat);
    def->label = "Fill Spacing";
    def->category = "Infill";
    def->tooltip = "Spacing between infill, expressed in mm in the range of 0 - 10mm.";
    def->sidetext = "mm";
    def->cli = "fill-spacing=f";
    def->min = 0;
    def->max = 50;
    ...
    def->enum_values.push_back("biorectilinear");
    ...
    def->enum_labels.push_back("Bio Rectilnear");
